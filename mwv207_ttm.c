...
#if	0
	ret = dma_resv_get_fences(bo->base.resv, DMA_RESV_USAGE_WRITE,
				...
				struct ttm_resource *new_mem)
{
	...
	dma_cmd->src.pg_nr_type = MWV207_DMA_NR_PAGES_VRAM(PFN_UP(bo->base.size));
				...
				struct ttm_resource *new_mem)
{
	...
	dma_cmd->dst.pg_nr_type = MWV207_DMA_NR_PAGES_VRAM(PFN_UP(bo->base.size));
